...
import "./TablesYearDropdown.scss";

const TablesYearDropdown = ({ years, year, setYear, setParentOpen }) => {
  ...
  return (
    <div className="tables-years-container">
      <div
        className="heading"
        onClick={() => {
          handleToggle();
...
export default TablesYearDropdown;
