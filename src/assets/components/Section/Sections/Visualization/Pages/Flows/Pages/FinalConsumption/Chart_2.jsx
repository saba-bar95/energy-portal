...
const Chart_1 = () => {
  ...
  const geoID = language === "ka" ? "consumption-2" : "";

  const text = {
    ka: {
      title: "ენერგორესურსების საბოლოო მოხმარება სექტორების მიხედვით",
      unit: "ათასი ტნე",
    },

    en: {
      title: "Final consumption of energy resources by sectors",
      unit: "ktoe",
    },
  };
  ...
  const CustomLegend = ({ payload }) => {
    return (
      <div className="legend-container ss" id={geoID}>
